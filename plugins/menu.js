...
%readmore`.trimStart(),
  ...
  footer: '',
  after: `Kisuke Botz masih dalam tahap pengembangan.
`,
}
...
// Fake Contact
 const fcon = {
    ...
    let thumb = 'https://i.ibb.co/DkFJ8dc/20230507-212733.jpg'
    let menu = [
    '🗿'
    ]
    ...
    conn.sendButton(m.chat, text.trim(),"2023 © Kisuke Botz", await (await fetch(thumb)).buffer(), [['Owner', '.owner'],['Donasi', '.donasi'],['Speed', '.speed']], true, { quoted: m })
